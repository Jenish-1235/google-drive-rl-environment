  ...
  return (
    <div className="create-account-page-container">
      ...
      <div className="create-account-card">
        ...
        {/* Heading */}
        <h1 className="create-account-heading">Create a Google Account</h1>
        <p className="create-account-subheading">Enter your name</p>
        ...
        <div className="create-account-actions">
          <button className="create-account-next-btn">Next</button>
        </div>
      </div>
