  ...
  return (
    <div className="forgot-email-page-container">
      ...
      <div className="forgot-email-card">
        ...
        {/* Heading */}
        <h1 className="forgot-email-heading">Find your email</h1>
        <p className="forgot-email-subheading">Enter your phone number or recovery email</p>
        ...
        <div className="forgot-email-actions">
          <button className="forgot-next-btn">Next</button>
        </div>
      </div>
